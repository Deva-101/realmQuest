...
public class Room implements Serializable {
    ...
    public String getObjectString() {
        ...
        // Get all of the descriptions of the objects
        for(AdventureObject obj: objectsInRoom) {
            itemNames.add(obj.getDescription());
        }
    ...
    public String getCommands() {
        ...
        for(Passage passage: this.getMotionTable().passageTable) {
            if(!commands.contains(passage.getDirection())) {
